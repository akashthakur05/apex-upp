          ...
          {loading === 'apple' ? (
            ...
            <span className="flex items-center gap-2">
              <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.05 13.5c-.91 0-1.82.55-2.25 1.51.93.64 1.54 1.76 1.54 3.02 0 2.05-1.53 3.76-3.5 3.76-1.9 0-3.5-1.71-3.5-3.76 0-1.26.61-2.38 1.54-3.02-.43-.96-1.34-1.51-2.25-1.51-2.26 0-4.09 2.01-4.09 4.5 0 2.48 1.83 4.5 4.09 4.5 1.17 0 2.26-.47 3.05-1.24.79.77 1.88 1.24 3.05 1.24 2.26 0 4.09-2.02 4.09-4.5 0-2.49-1.83-4.5-4.09-4.5z" />
              </svg>
              Sign in with Apple
            </span>
          )}
